...
var SPECHUB_DIR, CHANGES_DIR, MAPS_DIR, SPECS_DIR, ARCHIVE_DIR, CONFIG_FILE, VOCABULARY_PATH, GLOBAL_CONFIG_DIR, GLOBAL_CONFIG_FILE, GLOBAL_DATA_DIR;
...
import { join as join11, relative, resolve as resolve5 } from "node:path";
function loadVocabulary() {
  ...
  const path = join11(pluginRoot, VOCABULARY_PATH);
  let markdown = null;
  try {
...
var pkg = JSON.parse(
  readFileSync9(join12(import.meta.dirname, "..", "package.json"), "utf-8")
);
